...
async function testPasswordChange() {
  try {
    ...
    const changePasswordResponse = await axios.put('http://localhost:3000/api/trainer/change-password', {
    ...
    await axios.put('http://localhost:3000/api/trainer/change-password', {
